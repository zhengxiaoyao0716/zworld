...
const Physijs = (function () { // https://github.com/chandlerprall/Physijs
	'use strict';
	...
	Physijs.Scene.prototype = new THREE.Group;
	...
	Physijs.Scene.prototype.add = function (...objects) {
		THREE.Object3D.prototype.add.apply(this, objects);
		objects.filter(object => object._physijs).forEach(object => {
			object.world = this;
	...
	Physijs.Scene.prototype.remove = function (...objects) {
		THREE.Object3D.prototype.remove.apply(this, objects);
		objects.filter(object => object != null).forEach(object => {
			if (object instanceof Physijs.Vehicle) {
	...
	Physijs.Group.prototype = new THREE.Group;
	Physijs.Group.prototype.constructor = Physijs.Group;
	Eventable.make(Physijs.Group);
...
Physijs.scripts.worker = './static/script/Physijs/physijs_worker.js';
// Physijs.scripts.ammo = './static/script/Physijs/ammo.js';  
